...
<h5>Please fill in this form to create an account!</h5>
    <div class="container">
        ...
        <form action="">
            ...
            <div class="form-item">
                ...
                <input type="password" name="admin_password_1" id="password" placeholder="Enter password">
                <input type="password" name="admin_password_2" id="confirmPassword" placeholder="Confirm password">
            </div>
            ...
            <div class="form-btns">
                <button class="signup_admin" type="submit" name="reg_user">Sign Up</button>
                <div class="options">
                    Already have an account? <a href="SignIn_admin.php">Login here</a>
                </div>
            </div>
    ...
    <script>
        ...
        const admin_password_1 = document.querySelector("#admin_password_1");
        const admin_password_2 = document.querySelector("#admin_password_2");
